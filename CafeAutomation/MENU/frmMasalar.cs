                ...
                foreach (Control item in this.Controls)
                {
                    ...
                    {   // Gelen masa 1 ve  durumu 1 ise 
                        ...
                        else if (item.Name == "btnMasa" + dr["ID"].ToString() && dr["DURUM"].ToString() == "2")
                        {
                            ...
                            {
                                DateTime dt1 = Convert.ToDateTime(returnedDate);
                                DateTime dt2 = DateTime.Now;

                                string st1 = Convert.ToDateTime(returnedDate).ToShortTimeString();
                        ...
                        {
                            item.BackgroundImage = (System.Drawing.Image)(CafeAutomation.Properties.Resources.table);
